        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeOfEvent = table.Column<TimeSpan>(type: "time", nullable: true),
                    DateOfEvent = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AcceptableAge = table.Column<int>(type: "int", nullable: true),
                    CostOfVisit = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesEvents_CategoryId",
